      ...
      <section class="mb-12">
        <div class="relative rounded-lg overflow-hidden">
          ...
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-8">
            ...
            <p class="text-gray-200 text-lg mb-4">{news.allNews[0]?.description || "Breaking News"}</p>
          </div>
        </div>
      </section>
      <section class="mb-12">
            ...
            <ul class="contents">
              <li class="hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden"><img
                  ...
                  src={news.technology[0]?.urlToImage || assets.news_bg}
                  alt="Tech News" />
                  <div class="p-4"><span class="text-blue-600 text-sm font-semibold">Technology</span>
                    ...
                    <p class="text-gray-600 mt-2">{new Date(news.technology[0]?.publishedAt).toLocaleDateString("en-GB")}</p>
                  </div>
                </div>
              </li>
              <li class="hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden"><img
                  class="w-full h-48 object-cover"
                  src={news.business[1]?.urlToImage || assets.news_bg}
                  alt="Business News" />
                  <div class="p-4"><span class="text-blue-600 text-sm font-semibold">Business</span>
                    ...
                    <p class="text-gray-600 mt-2">{new Date(news.business[1]?.publishedAt).toLocaleDateString("en-GB")}</p>
                  </div>
                </div>
              </li>
              <li class="hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden"><img
                  class="w-full h-48 object-cover"
                  src={news.science[0]?.urlToImage || assets.news_bg}
                  alt="Health News" />
                  <div class="p-4"><span class="text-blue-600 text-sm font-semibold">Science</span>
                    ...
                    <p class="text-gray-600 mt-2">{new Date(news.science[0]?.publishedAt).toLocaleDateString("en-GB")}</p>
                  </div>
                </div>
              </li>
              <li class="hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                <div class="bg-white rounded-lg shadow-sm overflow-hidden"><img
                  class="w-full h-48 object-cover"
                  src={news.sports[0]?.urlToImage || assets.news_bg}
                  ...
                  <div class="p-4"><span class="text-blue-600 text-sm font-semibold">Sports</span>
                    ...
                    <p class="text-gray-600 mt-2">{new Date(news.sports[0]?.publishedAt).toLocaleDateString("en-GB")}</p>
                  </div>
                </div>
              </li>
            </ul>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <article class="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                ...
                <div class="p-4">
                  ...
                  <p class="text-gray-600 mt-2">{news.sports[1]?.description || "Sports News"}
                  </p>
                  <p class="text-gray-500 text-sm mt-4">{new Date(news.sports[1]?.publishedAt).toLocaleDateString("en-GB")}</p>
                </div>
              </article>
              <article class="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-lg duration-500 ease-in-out transform hover:-translate-y-1">
                <img class="w-full h-48 object-cover"
                ...
                <div class="p-4">
                  ...
                  <p class="text-gray-600 mt-2">{news.sports[1]?.description || "sports News"}</p>
                  <p class="text-gray-500 text-sm mt-4">{new Date(news.sports[2]?.publishedAt).toLocaleDateString("en-GB")}</p>
                </div>
              </article>
            </div>
          </section>
